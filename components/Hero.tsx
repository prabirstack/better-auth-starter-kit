      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 sm:mb-12 flex justify-center">
          <div className="relative flex items-center gap-x-2 rounded-full px-4 py-2 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20 bg-white/50 backdrop-blur-sm">
            ...
            <span className="font-medium">New Enterprise features released</span>
            <a href="#" className="flex items-center gap-x-1 font-semibold text-indigo-600">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Unlock actionable insights from your data in minutes, not months. Our AI-powered
            analytics platform helps you make smarter decisions faster than ever before.
          </p>
          ...
          <div className="mt-14 grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-3 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-sm text-gray-500 mt-1">Customer satisfaction</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-bold text-indigo-600">500+</span>
              <span className="text-sm text-gray-500 mt-1">Enterprise clients</span>
            </div>
          </div>
        </div>
      </div>
